...
fn parse_simple_string(buffer: BytesMut) -> Result<(Message, usize)> {
...
fn parse_array(buffer: BytesMut) -> Result<(Message, usize)> {
...
fn parse_bulk_string(buffer: BytesMut) -> Result<(Message, usize)> {
